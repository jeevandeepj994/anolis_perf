...
#define TXGBE_VT_MSGTYPE_ACK    0x80000000 /* Messages below or'd with this are the ACK */
#define TXGBE_VT_MSGTYPE_NACK   0x40000000 /* Messages below or'd with this are the NACK */
#define TXGBE_VT_MSGTYPE_CTS    0x20000000 /* Indicates that VF is still clear to send requests */
