...
#define SMC_RMBS_PER_LGR_MAX	32	/* max. # of RMBs per link group. Correspondingly,
					 * SMC_WR_BUF_CNT should not be less than 2 * SMC_RMBS_PER_LGR_MAX,
					 * since every connection at least has two rq/sq credits in average,
					 * otherwise may result in waiting for credits in sending process.
					 */
