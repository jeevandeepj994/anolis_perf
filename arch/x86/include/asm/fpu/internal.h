 ...
 */
static inline void switch_fpu_finish(struct fpu *prev_fpu, struct task_struct *next)
{
	...
	xdisable_switch(prev_fpu, new_fpu);
	...
	if (!(next->flags & PF_KTHREAD)) {
		 ...
		 */
		pk = get_xsave_addr(next_fpu, XFEATURE_PKRU);
