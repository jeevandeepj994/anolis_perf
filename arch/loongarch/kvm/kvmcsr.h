...
static inline int GET_HW_GCSR(id, csrid, v)
{
		if (csrid == id) {
...
static inline int GET_SW_GCSR(csr, id, csrid, v)
{
		if (csrid == id) {
...
static inline int SET_HW_GCSR(csr, id, csrid, v)
{
		if (csrid == id) {
...
static inline int SET_SW_GCSR(csr, id, csrid, v)
{
	if (csrid == id) {
...
static inline void CASE_WRITE_HW_PMU(vcpu, csr, id, csrid, v)
{
	if (csrid == id) {
